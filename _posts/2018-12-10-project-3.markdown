...
### Graph analysis :
Here is some paramter of the graph plot. There are 4887 compagnies/investors linked with 16914 edges in total. The sparsity of the plot is 0.0052 which means that the graph is really dense.
...
![Logo Jekyll]({{site.baseurl}}/img/portfolio/degree_plot/c.png)
...
![Logo Jekyll]({{site.baseurl}}/img/ecran/c.png)
